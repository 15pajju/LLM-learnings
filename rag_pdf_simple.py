...
def main():
    ...
    st.set_page_config(page_title="Simple RAG System", layout="centered")
    ...
    st.markdown("Ask questions based on your document or space facts.")
